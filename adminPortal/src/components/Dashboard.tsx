...
const Dashboard: React.FC = () => {
  ...
  return (
    ...
    <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Safety Control Center</h2>
        <p className="text-gray-600">Monitor worker safety across all active zones in real-time</p>
      </div>
